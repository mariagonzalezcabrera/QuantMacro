...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Brute Force Iterations')
...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Monotonicity of the Optimal Decision Rule')
plt.ylabel('Value Function')
plt.xlabel('Capital stock of today')
plt.show()
...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Concavity of the value function')
plt.ylabel('Value Function')
plt.xlabel('Capital stock of today')
plt.show()
...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Monotonicity and Concavity')
plt.ylabel('Value Function')
plt.xlabel('Capital stock of today')
plt.show()
...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Howards policy itearions')
plt.ylabel('Value Function')
plt.xlabel('Capital stock of today')
plt.show()
...
plt.figure()
plt.plot(ki, Vs1)
plt.title('Policy iterations with different reassessments')
plt.ylabel('Value Function')
plt.xlabel('Capital stock of today')
plt.show()
